...
CREATE TABLE `ansatte` (
  `idAnsatte` int(11) NOT NULL AUTO_INCREMENT,
  `navn` varchar(45) DEFAULT NULL,
  `Rolleid` int(11) DEFAULT NULL,
  PRIMARY KEY (`idAnsatte`),
  KEY `fk_Ansatte_roller1_idx` (`Rolleid`),
  CONSTRAINT `fk_Ansatte_roller1` FOREIGN KEY (`Rolleid`) REFERENCES `roller` (`Rolleid`) ON DELETE NO ACTION ON UPDATE NO ACTION
